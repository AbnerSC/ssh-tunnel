...
public class CopyItem {
	...
	private void splitTarget(String[] arr) {
		this.targetPort = Integer.valueOf(Integer.parseInt(arr[0]));
		this.host = arr[1];
		this.port = Integer.valueOf(Integer.parseInt(arr[2]));
	}

	private void splitTarget(String str) {
		String[] arr = str.split("-");
		this.targetPort = Integer.valueOf(Integer.parseInt(arr[1]));
		arr = arr[0].split(":");
		this.host = arr[0];
		this.port = Integer.valueOf(Integer.parseInt(arr[1]));
	}
